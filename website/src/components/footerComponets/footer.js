...
function Footer() {
  return (
    <section className="forContacts">
      <section className="center footer">
        <article className="footer__general">
          <h3>Фотограф в Санкт-Петербурге Смирнова Диана</h3>
          <a href="tel:+79523527979" style={{ color: "black" }}>
            Телефон: +7(952)352-79-79
          </a>
          <h3>В социальных сетях: @ssmirnvv </h3>
        </article>
        <article className="footer__messengers">
